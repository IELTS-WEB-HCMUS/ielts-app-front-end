...
module.exports = {
    getDashboard: async (req, res, next) => {
        try {
            ...
            const percent = Math.floor((userTarget.data.TargetListening + userTarget.data.TargetReading + userTarget.data.TargetSpeaking + userTarget.data.TargetWriting) / 4 * statisticList.length) / 100;
